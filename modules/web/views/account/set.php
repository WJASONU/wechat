	...
	<div class="col-lg-12">
		...
		<div class="form-horizontal m-t m-b">
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" name="nickname" class="form-control" placeholder="请输入姓名~~" value="张三">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" name="mobile" class="form-control" placeholder="请输入手机~~" value="1XX12345678">
				</div>
			</div>
			<div class="hr-line-dashed"></div>
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" name="email" class="form-control" placeholder="请输入邮箱~~" value="test@163.com">
				</div>
			</div>
			<div class="hr-line-dashed"></div>
			<div class="form-group">
