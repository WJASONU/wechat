...
<link href="/css/web/style.css?ver=20180226180701" rel="stylesheet"></head>
    ...
    <div class="col-lg-12">
        ...
        <div class="form-horizontal m-t m-b">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="mobile" class="form-control" placeholder="请输入手机~~"  readonly value="1XX123456789">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="nickname" class="form-control" placeholder="请输入姓名~~" value="wechat">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="email" class="form-control" placeholder="请输入邮箱~~" value="test@126.com">
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
