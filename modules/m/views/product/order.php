...
<div class="order_box">
    ...
    <ul class="address_list">
                ...
                <label>
                    ...
                    广东省惠州市惠城区演达大道46号惠州学院（张三收）1XX12311231                </label>

            </li>
                        <li style="padding: 5px 5px;">
                <label>
                    <input style="display: inline;" type="radio" name="address_id" value="1"   >
                    广东省惠州市惠城区演达大道46号惠州学院（李四收）1XX123456789                </label>
...
<div class="op_box">
    ...
    <a href="/m/pay/buy">
	<input style="width: 100%;" type="button" value="确定下单" class="red_btn do_order"  /></a>
</div>
</div>
